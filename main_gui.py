...
class mywindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.HORISONTAL_IN_BEAM_SET_BUTTON.clicked.connect(self.HORISONTAL_IN_BEAM_SET_BUTTON_clicked)
        self.ui.HORISONTAL_DELTA_SET_BUTTON.clicked.connect(self.HORISONTAL_DELTA_SET_BUTTON_clicked)
        self.ui.HORISONTAL_HOME_SET_BUTTON.clicked.connect(self.HORISONTAL_HOME_SET_BUTTON_clicked)
        ...
        self.ui.MOVE_X_INBEAM.clicked.connect(self.MOVE_X_INBEAM_clicked)
        self.ui.MOVE_X_OUTBEAM.clicked.connect(self.MOVE_X_OUTBEAM_clicked)
        self.ui.MOVE_X_HOME.clicked.connect(self.MOVE_X_HOME_clicked)
    ...
    def MOVE_X_INBEAM_clicked(self):
        self.epics.Write_PV('COMMAND',"MOVE_X_INBEAM")

    def MOVE_X_OUTBEAM_clicked(self):
        self.epics.Write_PV('COMMAND',"MOVE_X_OUTBEAM")

    def MOVE_X_HOME_clicked(self):
        self.epics.Write_PV('COMMAND',"MOVE_X_HOME")
    ...
    def HORISONTAL_IN_BEAM_SET_BUTTON_clicked(self):
        if globals.on_state == "ON":
    ...
    def HORISONTAL_DELTA_SET_BUTTON_clicked(self):
        if globals.on_state == "ON":
    ...
    def HORISONTAL_HOME_SET_BUTTON_clicked(self):
        if globals.on_state == "ON":
